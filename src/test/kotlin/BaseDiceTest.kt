...
internal class BaseDiceTest {
    ...
    fun combinations() {
        ...
        for ( i in 0..5 ) {
            assertEquals(i+1,rc[i].Nums[0])
            assertEquals(1,rc[i].Times)
        }
        bd = BaseDice(2, 4, 6)
        rc = bd.Combinations()
        assertEquals(21,rc.size)
        assertArrayEquals(intArrayOf(1,1),rc[0].Nums)
        assertEquals(1,rc[0].Times)
        assertArrayEquals(intArrayOf(2,1),rc[1].Nums)
        assertEquals(2,rc[1].Times)
        assertArrayEquals(intArrayOf(2,2),rc[2].Nums)
        assertEquals(1,rc[2].Times)
        assertArrayEquals(intArrayOf(3,1),rc[3].Nums)
        assertEquals(2,rc[3].Times)
        assertArrayEquals(intArrayOf(3,2),rc[4].Nums)
        assertEquals(2,rc[4].Times)
        assertArrayEquals(intArrayOf(3,3),rc[5].Nums)
        ...
        assertArrayEquals(intArrayOf(1,1,1),rc[0].Nums)
        assertEquals(1,rc[0].Times)
        assertArrayEquals(intArrayOf(2,1,1),rc[1].Nums)
        assertEquals(3,rc[1].Times)
        assertArrayEquals(intArrayOf(2,2,1),rc[2].Nums)
        assertEquals(3,rc[2].Times)
        assertArrayEquals(intArrayOf(2,2,2),rc[3].Nums)
        assertEquals(1,rc[3].Times)
        assertArrayEquals(intArrayOf(3,1,1),rc[4].Nums)
        assertEquals(3,rc[4].Times)
        assertArrayEquals(intArrayOf(3,2,1),rc[5].Nums)
